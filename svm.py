...
if __name__ == '__main__':
    ...
    ############################################################
    kwargs['svm_c'] = opts.svm_c
    kwargs['svm_tol'] = opts.svm_tol
    kwargs['svm_max_iter'] = opts.svm_max_iter
    kwargs['svm_degree'] = opts.svm_degree
    kwargs['svm_gamma'] = opts.svm_gamma
    kwargs['svm_coef0'] = opts.svm_coef0
    kwargs['svm_gs']=opts.svm_gs
    kwargs['svm_top']=opts.svm_top
    ############################################################
